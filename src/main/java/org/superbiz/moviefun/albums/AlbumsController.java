...
public class AlbumsController {
    ...
    public String uploadCover(@PathVariable long albumId, @RequestParam("file") MultipartFile uploadedFile) throws IOException {
        saveUploadToFile(uploadedFile, getCoverFileName(albumId));
    ...
    public HttpEntity<byte[]> getCover(@PathVariable long albumId) throws IOException, URISyntaxException {
        ...
        Blob blob = maybeBlob.orElseGet(this::buildDefaultCoverBlob);
    ...
    private void saveUploadToFile(@RequestParam("file") MultipartFile uploadedFile, String targetFileName) throws IOException {
        blobStore.put(new Blob(targetFileName, uploadedFile.getInputStream(), uploadedFile.getContentType()));
    }
